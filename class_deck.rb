...
class Card
  attr_reader :trivia_data, :question1, :question2, :question3, :answer1, :answer2, :answer3 

  def initialize(input_options)
    @question1 = input_options[:question1]
    @answer1= input_options[:answer1]
     @question2 = input_options[:questio2]
    @answer2 = input_options[:answer2]
     @question3 = input_options[:question3]
    @answer3 = input_options[:answer3]
